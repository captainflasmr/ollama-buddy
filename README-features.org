...
(use-package ollama-buddy
  ...
  (ollama-buddy-openai-api-key
   (lambda () (auth-source-pick-first-password :host "ollama-buddy-openai" :user "apikey")))
  (ollama-buddy-default-model "GPT gpt-4o")
  (ollama-buddy-claude-api-key
   (lambda () (auth-source-pick-first-password :host "ollama-buddy-claude" :user "apikey")))
...
(use-package ollama-buddy
  ...
  :custom
  (ollama-buddy-openai-api-key
   (lambda () (password-store-get "ollama-buddy/openai-api-key")))
  (ollama-buddy-default-model "GPT gpt-4o")
  (ollama-buddy-claude-api-key
   (lambda () (password-store-get "ollama-buddy/claude-api-key")))
  (ollama-buddy-claude-default-model "claude-3-sonnet-20240229")
  :config
  (require 'ollama-buddy-openai nil t)
  (require 'ollama-buddy-claude nil t)
