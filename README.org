...
u  Token Stats             J  Edit History        Q  List Sessions       K  Reset Parameters
...
| TODO                                                | DONE                                       |
|-----------------------------------------------------+--------------------------------------------|
| Conversation history to display with Claude/ChatGPT | System prompt not cleared on new session   |
| Add Texinfo to MELPA recipe                         | Remove fabric from Commands transient menu |
