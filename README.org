...
| TODO                                | DOING                              | DONE                                       |
|-------------------------------------+------------------------------------+--------------------------------------------|
| Add gemini?                         | Merge history buffer functionality | Method for securely storing API keys       |
| Pull ChatGPT and Claude model names | Core Params - suffix               | Core API - Delete Model                    |
| Core API - Embeddings               | Show incoming ollama messages      | Core API - Copy a model                    |
| Core Params - format                | Add chatGPT awesome prompt support | Core API - stream                          |
| Core Params - template              | Add fabric pattern/prompt support  | Core API - Pull/Info/Pull/Delete a model   |
| Core Params - raw                   | ChatGPT support                    | Core API - Show running models             |
| Test on Windows                     | Claude support                     | Core API - Create a model from a GGUF file |
|                                     |                                    | Add transient menu                         |
|                                     |                                    | History editing                            |
