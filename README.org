...
| TODO                                                                         | DOING                                      | DONE                                                                  |
|------------------------------------------------------------------------------+--------------------------------------------+-----------------------------------------------------------------------|
| chat ollama names to include prefix                                          | Kill online AI process with cancel request | Still some encoding issues on returns from online AI                  |
| transient-setup: Key sequence 1 0 starts with non-prefix key 1               | GGUF to use new syncing option             | Conversation history to display with Claude/ChatGPT                   |
