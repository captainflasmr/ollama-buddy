...
- *RAG Transient Menu* -- =C-c r= opens RAG transient menu directly (replaces individual =C-c r i/s/a/l/d/0= bindings)
- *System Prompt Reset* -- =C-c C-r= to reset system prompt in chat; =C-r= in main transient System Prompts section
