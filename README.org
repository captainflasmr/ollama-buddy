...
| Version | Summary                                                                                                                                                                                                                   |
|---------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *7.3.0* | Direct agent launch — external tools not in =ollama launch= can now be invoked as standalone executables; Oh My Pi (=omp=) added as first direct agent; =:model-flag= for flexible model passing.                         |
