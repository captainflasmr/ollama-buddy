...
- *Thinking Stream Visibility* -- Toggle live viewing of thinking tokens with =C-c V=.  When enabled, thinking content streams visibly under the =*** Think= heading, then gets converted and folded on completion.  A =◐= indicator appears in the header line when active.
- *Fixed thinking content duplication* -- Corrected marker tracking so raw streamed text is properly replaced by converted content.

* Recent Changes

| Version | Summary                                                                                                                                                                                                                   |
|---------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| *3.4.1* | Thinking Stream Visibility — =C-c V= toggles live display of thinking tokens; =◐= header indicator.                                                                                                                       |
...
| C-c V     | Toggle thinking visibility    |
