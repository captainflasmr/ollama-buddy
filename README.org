...
| =/api/delete=   | DELETE | Deletes available models           | Yes (but with "ollama rm") |                                   |
...
| =/api/copy=     | POST   | Copy a model                       | No                         | Yes                               |
...
| TODO                    | DOING                             | DONE                                       |
|-------------------------+-----------------------------------+--------------------------------------------|
| Core API - Delete Model | Core Params - suffix              | Core API - stream                          |
| Core API - Copy a model | Show incoming ollama messages     | Core API - Pull/Info/Pull/Delete a model   |
| Core API - Embeddings   | Add fabric pattern/prompt support | Core API - Show running models             |
| Core Params - format    |                                   | Core API - Create a model from a GGUF file |
| Core Params - template  |                                   | Add transient menu                         |
| Core Params - raw       |                                   | History editing                            |
| Test on Windows         |                                   | Core API - options - parameter editing     |
...
** TODO Core API - Delete Model
Revisit as currently running command "ollama rm" but really should send DELETE through the Core API

** TODO Core API - Copy a model
