...
| TODO                                                       | DOING                                                         | DONE                                         |
|------------------------------------------------------------+---------------------------------------------------------------+----------------------------------------------|
| Autoload intelligently? to speed up initial reponse times? | Add option to hide reasoning in chat buffer                   | Show token parameters as part of token stats |
| Core API - Embeddings                                      | Unload all models?, to free up RAM if you are switching alot? | Autogenerate session save name               |
| Core Params - format                                       | Core Params - suffix                                          | Add gemini?                                  |
| Core Params - template                                     |                                                               | Pull ChatGPT and Claude model names          |
| Core Params - raw                                          |                                                               | Merge history buffer functionality           |
| Test on Windows                                            |                                                               | Show incoming ollama messages                |
