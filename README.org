...
| Claude request and connection can sometimes take time and it blocks!         | GGUF to use new syncing option             | As shell generally C-n to end of list to clear prompt history |
...
| Save system prompts as part of session                                       |                                            | First request with no chat buffer fails                       |
