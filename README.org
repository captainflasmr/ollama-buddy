...
| TODO                                | DOING                              | DONE                                       |
|-------------------------------------+------------------------------------+--------------------------------------------|
| Add gemini?                         | Core Params - suffix               | Method for securely storing API keys       |
| Pull ChatGPT and Claude model names | Show incoming ollama messages      | Core API - Delete Model                    |
| Merge history buffer functionality  | Add chatGPT awesome prompt support | Core API - Copy a model                    |
| Core API - Embeddings               | Add fabric pattern/prompt support  | Core API - stream                          |
| Core Params - format                | ChatGPT support                    | Core API - Pull/Info/Pull/Delete a model   |
| Core Params - template              | Claude support                     | Core API - Show running models             |
