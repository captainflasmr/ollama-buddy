...
| TODO                                                   | DONE                                                    |
|--------------------------------------------------------+---------------------------------------------------------|
| Create a model from a GGUF file                        | Chat buffer to use org-mode                             |
| Show incoming ollama messages                          | Chat export options - Provide various export formats    |
| Maybe allowing the pulling of a model through ollama?  | Add temperature                                         |
| Fully leverage the ollama API with advanced parameters | Managing Sessions                                       |
| API - show model information                           | Create a very sparse minified version of =ollama-buddy= |
| API - generate full response in one go if desired?     | Customizable Role-Based Menus Preset System             |
| API - images?                                          | Add to MELPA                                            |
| API - suffix                                           | Enhancing Menu Clarity: Distinguishing LLMs Effectively |
| API - system prompt?                                   | Add real time token tracking and usage summary          |
| Embeddings?                                            | Managing chat history and context                       |
| Test on Windows                                        |                                                         |
...
** DONE Chat export options - Provide various export formats

** DONE Add temperature

** DONE Managing Sessions

** DONE Create a very sparse minified version of =ollama-buddy=

** DONE Customizable Role-Based Menus Preset System

** DONE Add to MELPA

** DONE Enhancing Menu Clarity: Distinguishing LLMs Effectively

** DONE Add real time token tracking and usage summary

** DONE Managing chat history and context

** TODO Create a model from a GGUF file

** TODO Show incoming ollama messages

** TODO Maybe allowing the pulling of a model through ollama?

** TODO Fully leverage the ollama API with advanced parameters

*** TODO API - show model information

*** TODO API - generate full response in one go if desired?
