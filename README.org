...
| TODO                                                                 | DONE                                                          |
|----------------------------------------------------------------------+---------------------------------------------------------------|
| transient-setup: Key sequence 1 0 starts with non-prefix key 1       | As shell generally C-n to end of list to clear prompt history |
| Claude request and connection can sometimes take time and it blocks! | Add Texinfo to MELPA recipe                                   |
| =C-a= beginning-of-line to jump to prompt start like comint          | System prompt not cleared on new session                      |
| Pushing hundreds/thousands of lines to the chat buffer takes a while | Remove fabric from Commands transient menu                    |
...
** TODO =C-a= beginning-of-line to jump to prompt start like comint

** TODO Pushing hundreds/thousands of lines to the chat buffer takes a while
