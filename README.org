...
| TODO                                                                 | DONE                                       |
|----------------------------------------------------------------------+--------------------------------------------|
| Pushing hundreds/thousands of lines to the chat buffer takes a while | Add Texinfo to MELPA recipe                |
| Conversation history to display with Claude/ChatGPT                  | System prompt not cleared on new session   |
| ChatGPT request/response too long                                    | Remove fabric from Commands transient menu |
| Check tags caching                                                   | External AI to copy to register            |
| Kill online AI process with cancel request                           | First request with no chat buffer fails    |
...
| TODO                               | DOING                              | DONE                                       |
|------------------------------------+------------------------------------+--------------------------------------------|
| Merge history buffer functionality | Core Params - suffix               | Method for securely storing API keys       |
| Core API - Embeddings              | Show incoming ollama messages      | Core API - Delete Model                    |
| Core Params - format               | Add chatGPT awesome prompt support | Core API - Copy a model                    |
| Core Params - template             | Add fabric pattern/prompt support  | Core API - stream                          |
| Core Params - raw                  | ChatGPT support                    | Core API - Pull/Info/Pull/Delete a model   |
| Test on Windows                    | Claude support                     | Core API - Show running models             |
