...
| TODO                                                 | DONE                                                    |
|------------------------------------------------------+---------------------------------------------------------|
| Create more specialized system prompts               | Managing Sessions                                       |
| Chat export options - Provide various export formats | Create a very sparse minified version of =ollama-buddy= |
| Fully leverage the ollama API                        | Customizable Role-Based Menus Preset System             |
| Test on Windows                                      | Add to MELPA                                            |
| Advanced parameters, and temperature and others?     | Enhancing Menu Clarity: Distinguishing LLMs Effectively |
...
** TODO Chat export options - Provide various export formats

** TODO Fully leverage the ollama API

** TODO Test on Windows

** TODO Advanced parameters, and temperature and others?
