...
| TODO                                                   | DONE                                                    |
|--------------------------------------------------------+---------------------------------------------------------|
| Create more specialized system prompts                 | Chat buffer to use org-mode                             |
| Fully leverage the ollama API with advanced parameters | Chat export options - Provide various export formats    |
| Test on Windows                                        | Add temperature                                         |
|                                                        | Managing Sessions                                       |
|                                                        | Create a very sparse minified version of =ollama-buddy= |
|                                                        | Customizable Role-Based Menus Preset System             |
|                                                        | Add to MELPA                                            |
|                                                        | Enhancing Menu Clarity: Distinguishing LLMs Effectively |
|                                                        | Add real time token tracking and usage summary          |
...
See conversion of the chat buffer to org-mode meaning that the ox export functionality now becomes available!
