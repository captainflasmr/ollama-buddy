...
- *=/= Slash Commands* -- Typing =/= in the prompt area triggers =completing-read= with action commands (=model=, =clear=, =save=, =load=, =tools=, =context=, =help=). Execute immediately; =C-g= inserts literal =/=.
