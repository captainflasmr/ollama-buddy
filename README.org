...
(b) qwen2.5-coder:3b Select Info Pull Copy Delete
(c) qwen2.5-coder:7b Select Info Pull Copy Delete
(d) deepseek-r1:7b Select Info Pull Copy Delete
(e) codellama:7b Select Info Pull Copy Delete
(f) gemma3:4b Select Info Pull Copy Delete
(g) phi3:3.8b Select Info Pull Copy Delete
(h) llama3.2:1b Select Info Pull Copy Delete
(i) gemma3:1b Select Info Pull Copy Delete
(j) llama3.2:3b Select Info Pull Copy Delete
(k) deepseek-r1:1.5b Select Info Pull Copy Delete

** Recommended Models (click to download)

starcoder2:3b mistral:7b
