...
** TODO First request with no chat buffer fails
...
| TODO                               | DOING                             | DONE                                       |
|------------------------------------+-----------------------------------+--------------------------------------------|
| Merge history buffer functionality | Core Params - suffix              | Core API - Delete Model                    |
| Core API - Embeddings              | Show incoming ollama messages     | Core API - Copy a model                    |
| Core Params - format               | Add fabric pattern/prompt support | Core API - stream                          |
| Core Params - template             |                                   | Core API - Pull/Info/Pull/Delete a model   |
| Core Params - raw                  |                                   | Core API - Show running models             |
| Test on Windows                    |                                   | Core API - Create a model from a GGUF file |
|                                    |                                   | Add transient menu                         |
|                                    |                                   | History editing                            |
