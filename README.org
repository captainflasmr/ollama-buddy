...
| TODO                                                | DONE                                       |
|-----------------------------------------------------+--------------------------------------------|
| Conversation history to display with Claude/ChatGPT | Add Texinfo to MELPA recipe                |
| ChatGPT request/response too long                   | System prompt not cleared on new session   |
| Check tags caching                                  | Remove fabric from Commands transient menu |
| Kill online AI process with cancel request          | External AI to copy to register            |
| GGUF to use new syncing option                      | First request with no chat buffer fails    |
