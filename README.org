...
- Navigation functions to jump between prompts and responses using C-c C-n/C-p and variants
- Keybindings

| Keybinding            | Function                        | Description                          |
|-----------------------+---------------------------------+--------------------------------------|
| =C-c p= / =C-c n=     | Previous/next conversation item | Jump to either prompt or response    |
| =C-c C-p= / =C-c C-n= | Previous/next prompt            | Jump specifically to user prompts    |
| =C-c M-p= / =C-c M-n= | Previous/next response          | Jump specifically to model responses |
