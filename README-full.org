...
- ⚒ indicator shown next to tool-capable models in header line, =C-c m= completing-read, and model management buffer (=C-c M=)
- ⊙ indicator also shown for vision-capable models in completing-read
...
| =/api/embed=              | POST   | Generate embeddings from text      | No        | Future consideration                       |
...
*** DOING GitHub Copilot Integration Improvements
...
The =/api/embed= endpoint could enable semantic search and RAG workflows.

*Implementation considerations:*
- Vector storage and similarity search
- Integration with org-mode notes
- Potential for semantic file search
...
*** TODO Structured Outputs (JSON Schema)
