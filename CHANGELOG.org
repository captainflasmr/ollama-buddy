...
|---------+--------------------------------------+---------------------------|
| C-c r i | =ollama-buddy-rag-index-directory=   | Index a directory         |
| C-c r s | =ollama-buddy-rag-search=            | Search and display        |
| C-c r a | =ollama-buddy-rag-attach=            | Search and attach context |
| C-c r l | =ollama-buddy-rag-list-indexes=      | List available indexes    |
| C-c r d | =ollama-buddy-rag-delete-index=      | Delete an index           |
| C-c r 0 | =ollama-buddy-rag-clear-attached=    | Clear RAG context         |
