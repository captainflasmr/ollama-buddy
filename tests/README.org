...
#+RESULTS:
| Starting  | Emacs        | 28.1      | with                                  | minimal | configuration... |
| Testing   | ollama-buddy | from:     | /mnt/hgfs/SharedVM/ollama-buddy-main  |         |                  |
| Temporary | init         | file:     | /tmp/ollama-buddy-test-vTIv5I/init.el |         |                  |
