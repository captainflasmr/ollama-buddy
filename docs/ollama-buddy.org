...
- [[#In_002dBuffer-Replace][22 In-Buffer Replace]]
  ...
  - [[#Basic-Workflow][22.3 Basic Workflow]]
  - [[#Inline-Diff-View][22.4 Inline Diff View]]
  - [[#Key-Bindings-_0028while-rewrite-is-pending_0029][22.5 Key
    Bindings (while rewrite is pending)]]
  - [[#Automatic-Output-Polishing][22.6 Automatic Output Polishing]]
  - [[#Implementation-Notes][22.7 Implementation Notes]]
  - [[#Limitations][22.8 Limitations]]
...
:CLASS: section
:END:
Toggle via the transient Actions menu (C-c O, key W), the chat buffer
keybinding C-c W, or:
...
<<Basic-Workflow>>
*** 22.3 Basic Workflow [[#Basic-Workflow][¶]]
:PROPERTIES:
:CUSTOM_ID: basic-workflow
:CLASS: section
:END:
1. Toggle in-buffer replace on (W or C-c W).
...
<<Inline-Diff-View>>
*** 22.4 Inline Diff View [[#Inline-Diff-View][¶]]
:PROPERTIES:
...
*** 22.5 Key Bindings (while rewrite is pending) [[#Key-Bindings-_0028while-rewrite-is-pending_0029][¶]]
:PROPERTIES:
...
*** 22.6 Automatic Output Polishing [[#Automatic-Output-Polishing][¶]]
:PROPERTIES:
...
*** 22.7 Implementation Notes [[#Implementation-Notes][¶]]
:PROPERTIES:
