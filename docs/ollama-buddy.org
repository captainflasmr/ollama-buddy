...
- [[#Global-System-Prompt][17 Global System Prompt]]
  - [[#Overview-5][17.1 Overview]]
  - [[#Configuration-4][17.2 Configuration]]
  - [[#Toggling-Global-Prompt][17.3 Toggling Global Prompt]]
  - [[#How-It-Works-1][17.4 How It Works]]
- [[#Tone-Selector][18 Tone Selector]]
  - [[#Overview-6][18.1 Overview]]
  - [[#Usage-1][18.2 Usage]]
  - [[#Built_002din-Tones][18.3 Built-in Tones]]
  - [[#Configuration-5][18.4 Configuration]]
  - [[#How-It-Works-2][18.5 How It Works]]
- [[#Thinking-Blocks][19 Thinking Blocks]]
  - [[#Overview-7][19.1 Overview]]
  - [[#How-It-Works-3][19.2 How It Works]]
  - [[#Key-Bindings][19.3 Key Bindings]]
  - [[#Configuration-6][19.4 Configuration]]
- [[#Project-Integration][20 Project Integration]]
  - [[#Project-Awareness][20.1 Project Awareness]]
  - [[#Project-Commands][20.2 Project Commands]]
  - [[#Inline-Project-Command][20.3 Inline Project Command]]
  - [[#Project-Init-_0028experimental_0029][20.4 Project Init
    (experimental)]]
    - [[#Generating-a-summary][20.4.1 Generating a summary]]
    - [[#Auto_002dloading][20.4.2 Auto-loading]]
    - [[#Clean-project-switching][20.4.3 Clean project switching]]
    - [[#Regenerating][20.4.4 Regenerating]]
    - [[#Customization][20.4.5 Customization]]
- [[#In_002dBuffer-Replace][21 In-Buffer Replace]]
  - [[#Overview-8][21.1 Overview]]
  - [[#Enabling-In_002dBuffer-Replace][21.2 Enabling In-Buffer Replace]]
  - [[#Basic-Workflow][21.3 Basic Workflow]]
  - [[#Inline-Diff-View][21.4 Inline Diff View]]
  - [[#Key-Bindings-_0028while-rewrite-is-pending_0029][21.5 Key
    Bindings (while rewrite is pending)]]
  - [[#Automatic-Output-Polishing][21.6 Automatic Output Polishing]]
  - [[#Implementation-Notes][21.7 Implementation Notes]]
  - [[#Limitations][21.8 Limitations]]
- [[#Tool-Calling][22 Tool Calling]]
  - [[#Overview-9][22.1 Overview]]
  - [[#Setup][22.2 Setup]]
...
- [[#RAG][23 RAG (Retrieval-Augmented Generation)]]
  ...
  - [[#Incremental-Updates][23.8 Incremental Updates]]
  - [[#Pause-and-Resume][23.9 Pause and Resume]]
  - [[#Inline-_0040rag_0028_0029-Syntax][23.10 Inline @rag() Syntax]]
  - [[#Example-Workflow][23.11 Example Workflow]]
...
- Integrating with commercial APIs (OpenAI, Claude, Gemini, Grok,
  Copilot, Codestral, DeepSeek, OpenRouter)
...
- (Optional) API keys for remote providers (OpenAI, Claude, Gemini,
  Grok, Copilot, Codestral, DeepSeek, OpenRouter) if you want to use
  those services
...
or press =C-c p= and select “All Profiles” (A).
...
:CLASS: section
:END:
To rewind a conversation to a previous prompt, navigate to the desired
prompt heading in the chat buffer and press =C-u C-u C-c C-c=. You can
use standard Org navigation to get there:
...
If point is not on a prompt heading, a =completing-read= fallback
presents all prompts for selection.
...
- =✦= - Current model supports thinking/reasoning
...
- Provider letters: =a= (OpenAI), =c= (Claude), =g= (Gemini), =k=
  ...
  (OpenRouter), =l= (OpenAI-compat)

Example: =☁⚒⊙✦≡2♁1acgkpsdr= means cloud model with tools enabled, vision
support, thinking support, 2 file attachments, 1 web search, and all
eight external providers loaded.
...
** 17 Global System Prompt [[#Global-System-Prompt-1][¶]]
:PROPERTIES:
...
<<Configuration-4>>
*** 17.2 Configuration [[#Configuration-4][¶]]
:PROPERTIES:
...
*** 17.3 Toggling Global Prompt [[#Toggling-Global-Prompt][¶]]
:PROPERTIES:
...
<<How-It-Works-1>>
*** 17.4 How It Works [[#How-It-Works-1][¶]]
:PROPERTIES:
...
** 18 Tone Selector [[#Tone-Selector-1][¶]]
:PROPERTIES:
...
<<Built_002din-Tones>>
*** 18.3 Built-in Tones [[#Built_002din-Tones][¶]]
:PROPERTIES:
...
<<Configuration-5>>
*** 18.4 Configuration [[#Configuration-5][¶]]
:PROPERTIES:
...
<<How-It-Works-2>>
*** 18.5 How It Works [[#How-It-Works-2][¶]]
:PROPERTIES:
...
** 19 Thinking Blocks [[#Thinking-Blocks-1][¶]]
:PROPERTIES:
...
<<How-It-Works-3>>
*** 19.2 How It Works [[#How-It-Works-3][¶]]
:PROPERTIES:
...
<<Key-Bindings>>
*** 19.3 Key Bindings [[#Key-Bindings][¶]]
:PROPERTIES:
...
<<Configuration-6>>
*** 19.4 Configuration [[#Configuration-6][¶]]
:PROPERTIES:
...
** 20 Project Integration [[#Project-Integration-1][¶]]
:PROPERTIES:
...
<<Project-Awareness>>
*** 20.1 Project Awareness [[#Project-Awareness][¶]]
:PROPERTIES:
...
<<Project-Commands>>
*** 20.2 Project Commands [[#Project-Commands][¶]]
:PROPERTIES:
...
*** 20.3 Inline Project Command [[#Inline-Project-Command][¶]]
:PROPERTIES:
...
*** 20.4 Project Init (experimental) [[#Project-Init-_0028experimental_0029][¶]]
:PROPERTIES:
...
**** 20.4.1 Generating a summary [[#Generating-a-summary][¶]]
:PROPERTIES:
...
<<Auto_002dloading>>
**** 20.4.2 Auto-loading [[#Auto_002dloading][¶]]
:PROPERTIES:
...
**** 20.4.3 Clean project switching [[#Clean-project-switching][¶]]
:PROPERTIES:
...
<<Regenerating>>
**** 20.4.4 Regenerating [[#Regenerating][¶]]
:PROPERTIES:
...
<<Customization>>
**** 20.4.5 Customization [[#Customization][¶]]
:PROPERTIES:
...
** 21 In-Buffer Replace [[#In_002dBuffer-Replace-1][¶]]
:PROPERTIES:
...
*** 21.2 Enabling In-Buffer Replace [[#Enabling-In_002dBuffer-Replace][¶]]
:PROPERTIES:
...
<<Basic-Workflow>>
*** 21.3 Basic Workflow [[#Basic-Workflow][¶]]
:PROPERTIES:
...
<<Inline-Diff-View>>
*** 21.4 Inline Diff View [[#Inline-Diff-View][¶]]
:PROPERTIES:
...
*** 21.5 Key Bindings (while rewrite is pending) [[#Key-Bindings-_0028while-rewrite-is-pending_0029][¶]]
:PROPERTIES:
...
*** 21.6 Automatic Output Polishing [[#Automatic-Output-Polishing][¶]]
:PROPERTIES:
...
*** 21.7 Implementation Notes [[#Implementation-Notes][¶]]
:PROPERTIES:
...
- =ollama-buddy-rag-index-directory (==i==)= :: Index a directory.
  Prompts for the directory path, reads and chunks all matching files,
  then asynchronously generates embeddings. Progress is shown in the
  status line. File modification times are recorded so that future
  incremental updates can detect changes.

- =ollama-buddy-rag-update-directory (==u==)= :: Incrementally update an
  existing index. Only files that have been added or modified since the
  last indexing are re-chunked and re-embedded; chunks from unchanged
  files are retained. Chunks for deleted files are removed. If no
  existing index with metadata is found, a full re-index is performed
  automatically. If the embedding model has changed since the index was
  created, a full re-index is required and the user is prompted before
  proceeding.
...
<<Incremental-Updates>>
*** 23.8 Incremental Updates [[#Incremental-Updates][¶]]
:PROPERTIES:
...
Running Update Directory on such an index automatically falls back to a
full re-index and saves the metadata for future incremental updates.

<<Pause-and-Resume>>
*** 23.9 Pause and Resume [[#Pause-and-Resume][¶]]
:PROPERTIES:
...
- *Update directory* :: Running =M-x ollama-buddy-rag-update-directory=
  on a directory with a partial index will offer to resume it or start a
  fresh full re-index.

<<Inline-_0040rag_0028_0029-Syntax>>
*** 23.10 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 23.11 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
