...
- [[#Plan-Mode][24 Plan Mode]]
  - [[#Overview-11][24.1 Overview]]
  - [[#Workflow][24.2 Workflow]]
  - [[#TODO-States][24.3 TODO States]]
  - [[#Slash-Commands-1][24.4 Slash Commands]]
  - [[#Tool-Calling-Integration][24.5 Tool Calling Integration]]
  - [[#Customization-1][24.6 Customization]]
- [[#RAG][25 RAG (Retrieval-Augmented Generation)]]
  ...
  - [[#Configuration-9][25.5 Configuration]]
  - [[#PDF-Support][25.6 PDF Support]]
  - [[#Interactive-Commands-1][25.7 Interactive Commands]]
  - [[#Incremental-Updates][25.8 Incremental Updates]]
  - [[#Pause-and-Resume][25.9 Pause and Resume]]
  - [[#Inline-_0040rag_0028_0029-Syntax][25.10 Inline @rag() Syntax]]
  - [[#Example-Workflow][25.11 Example Workflow]]
...
<<Slash-Commands-1>>
*** 24.4 Slash Commands [[#Slash-Commands-1][¶]]
:PROPERTIES:
...
*** 24.5 Tool Calling Integration [[#Tool-Calling-Integration][¶]]
:PROPERTIES:
...
<<Customization-1>>
*** 24.6 Customization [[#Customization-1][¶]]
:PROPERTIES:
...
<<Configuration-9>>
*** 25.5 Configuration [[#Configuration-9][¶]]
:PROPERTIES:
...
<<Incremental-Updates>>
*** 25.8 Incremental Updates [[#Incremental-Updates][¶]]
:PROPERTIES:
...
<<Pause-and-Resume>>
*** 25.9 Pause and Resume [[#Pause-and-Resume][¶]]
:PROPERTIES:
...
*** 25.10 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 25.11 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
