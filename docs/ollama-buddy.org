...
- [[#Global-System-Prompt][18 Global System Prompt]]
  - [[#Overview-6][18.1 Overview]]
  - [[#Configuration-5][18.2 Configuration]]
  - [[#Toggling-Global-Prompt][18.3 Toggling Global Prompt]]
  - [[#How-It-Works-1][18.4 How It Works]]
- [[#Tone-Selector][19 Tone Selector]]
  - [[#Overview-7][19.1 Overview]]
  - [[#Usage-2][19.2 Usage]]
  - [[#Built_002din-Tones][19.3 Built-in Tones]]
  - [[#Configuration-6][19.4 Configuration]]
  - [[#How-It-Works-2][19.5 How It Works]]
- [[#Thinking-Blocks][20 Thinking Blocks]]
  - [[#Overview-8][20.1 Overview]]
  - [[#How-It-Works-3][20.2 How It Works]]
  - [[#Key-Bindings][20.3 Key Bindings]]
  - [[#Configuration-7][20.4 Configuration]]
- [[#Project-Integration][21 Project Integration]]
  - [[#Project-Awareness][21.1 Project Awareness]]
  - [[#Project-Commands][21.2 Project Commands]]
  - [[#Inline-Project-Command][21.3 Inline Project Command]]
  - [[#Project-Init-_0028experimental_0029][21.4 Project Init
    (experimental)]]
    - [[#Generating-a-summary][21.4.1 Generating a summary]]
    - [[#Auto_002dloading][21.4.2 Auto-loading]]
    - [[#Clean-project-switching][21.4.3 Clean project switching]]
    - [[#Regenerating][21.4.4 Regenerating]]
    - [[#Customization][21.4.5 Customization]]
...
- [[#Tool-Calling][23 Tool Calling]]
  ...
  - [[#Configuration-8][23.6 Configuration]]
...
- [[#RAG][24 RAG (Retrieval-Augmented Generation)]]
  ...
  - [[#Configuration-9][24.5 Configuration]]
  - [[#PDF-Support][24.6 PDF Support]]
  - [[#Interactive-Commands-1][24.7 Interactive Commands]]
  - [[#Incremental-Updates][24.8 Incremental Updates]]
  - [[#Pause-and-Resume][24.9 Pause and Resume]]
  - [[#Inline-_0040rag_0028_0029-Syntax][24.10 Inline @rag() Syntax]]
  - [[#Example-Workflow][24.11 Example Workflow]]
...
This runs =ollama launch FRONTEND --model MODEL= in a native terminal
window outside Emacs.
...
- Interactive :: =M-x ollama-buddy-launch=
...
- =ollama-buddy-launch-frontends= :: List of frontend names for
  =ollama launch= (default: =("claude")=). Add ="codex"= or others as
...
** 18 Global System Prompt [[#Global-System-Prompt-1][¶]]
:PROPERTIES:
...
<<Configuration-5>>
*** 18.2 Configuration [[#Configuration-5][¶]]
:PROPERTIES:
...
*** 18.3 Toggling Global Prompt [[#Toggling-Global-Prompt][¶]]
:PROPERTIES:
...
<<How-It-Works-1>>
*** 18.4 How It Works [[#How-It-Works-1][¶]]
:PROPERTIES:
...
** 19 Tone Selector [[#Tone-Selector-1][¶]]
:PROPERTIES:
...
<<Built_002din-Tones>>
*** 19.3 Built-in Tones [[#Built_002din-Tones][¶]]
:PROPERTIES:
...
<<How-It-Works-2>>
*** 19.5 How It Works [[#How-It-Works-2][¶]]
:PROPERTIES:
...
** 20 Thinking Blocks [[#Thinking-Blocks-1][¶]]
:PROPERTIES:
...
<<How-It-Works-3>>
*** 20.2 How It Works [[#How-It-Works-3][¶]]
:PROPERTIES:
...
<<Key-Bindings>>
*** 20.3 Key Bindings [[#Key-Bindings][¶]]
:PROPERTIES:
...
<<Configuration-7>>
*** 20.4 Configuration [[#Configuration-7][¶]]
:PROPERTIES:
...
** 21 Project Integration [[#Project-Integration-1][¶]]
:PROPERTIES:
...
<<Project-Awareness>>
*** 21.1 Project Awareness [[#Project-Awareness][¶]]
:PROPERTIES:
...
<<Project-Commands>>
*** 21.2 Project Commands [[#Project-Commands][¶]]
:PROPERTIES:
...
*** 21.3 Inline Project Command [[#Inline-Project-Command][¶]]
:PROPERTIES:
...
*** 21.4 Project Init (experimental) [[#Project-Init-_0028experimental_0029][¶]]
:PROPERTIES:
...
**** 21.4.1 Generating a summary [[#Generating-a-summary][¶]]
:PROPERTIES:
...
<<Auto_002dloading>>
**** 21.4.2 Auto-loading [[#Auto_002dloading][¶]]
:PROPERTIES:
...
**** 21.4.3 Clean project switching [[#Clean-project-switching][¶]]
:PROPERTIES:
...
<<Regenerating>>
**** 21.4.4 Regenerating [[#Regenerating][¶]]
:PROPERTIES:
...
<<Customization>>
**** 21.4.5 Customization [[#Customization][¶]]
:PROPERTIES:
...
<<Configuration-8>>
*** 23.6 Configuration [[#Configuration-8][¶]]
:PROPERTIES:
...
<<Configuration-9>>
*** 24.5 Configuration [[#Configuration-9][¶]]
:PROPERTIES:
...
<<Incremental-Updates>>
*** 24.8 Incremental Updates [[#Incremental-Updates][¶]]
:PROPERTIES:
...
<<Pause-and-Resume>>
*** 24.9 Pause and Resume [[#Pause-and-Resume][¶]]
:PROPERTIES:
...
*** 24.10 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 24.11 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
