...
- [[#Remote-Providers][16 Remote Providers]]
  - [[#Overview-2][16.1 Overview]]
  - [[#Status-Line-Indicators][16.2 Status Line Indicators]]
  - [[#Setting-Up-API-Access][16.3 Setting Up API Access]]
  - [[#Selecting-Remote-Models][16.4 Selecting Remote Models]]
  - [[#Provider-Configuration][16.5 Provider Configuration]]
    - [[#OpenAI-Configuration][16.5.1 OpenAI Configuration]]
    - [[#Claude-Configuration][16.5.2 Claude Configuration]]
    - [[#Gemini-Configuration][16.5.3 Gemini Configuration]]
    - [[#Grok-Configuration][16.5.4 Grok Configuration]]
    - [[#Codestral-Configuration][16.5.5 Codestral Configuration]]
  - [[#History-Management][16.6 History Management]]
- [[#Ollama-Cloud-Models][17 Ollama Cloud Models]]
  - [[#Overview-3][17.1 Overview]]
  - [[#Available-Cloud-Models][17.2 Available Cloud Models]]
  - [[#Selecting-Cloud-Models][17.3 Selecting Cloud Models]]
  - [[#Cloud-Authentication][17.4 Cloud Authentication]]
  - [[#Cloud-Model-Indicator][17.5 Cloud Model Indicator]]
  - [[#Configuration-2][17.6 Configuration]]
- [[#Global-System-Prompt][18 Global System Prompt]]
  - [[#Overview-4][18.1 Overview]]
  - [[#Configuration-3][18.2 Configuration]]
  - [[#Toggling-Global-Prompt][18.3 Toggling Global Prompt]]
  - [[#How-It-Works][18.4 How It Works]]
- [[#Advanced-Usage][19 Advanced Usage]]
  - [[#Managing-Token-Usage][19.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][19.2 Customizing the Interface]]
    - [[#Streaming-Options][19.2.1 Streaming Options]]
    - [[#Debug-Mode][19.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][19.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][19.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][19.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][19.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][19.5 Using Direct API Access]]
- [[#API-Reference][20 API Reference]]
  - [[#Interactive-Functions][20.1 Interactive Functions]]
  - [[#Core-Functions][20.2 Core Functions]]
  - [[#Customization-Functions][20.3 Customization Functions]]
- [[#FAQ][21 Frequently Asked Questions]]
  - [[#General-Questions][21.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][21.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][21.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][21.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][21.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][21.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][21.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][21.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][21.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][21.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][21.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][21.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][21.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][21.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][21.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][21.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-1][21.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][21.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][21.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][21.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][21.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][21.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][21.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][21.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][21.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][22 Troubleshooting]]
  - [[#Common-Issues][22.1 Common Issues]]
    - [[#Connection-Problems][22.1.1 Connection Problems]]
    - [[#Model-Problems][22.1.2 Model Problems]]
    - [[#Interface-Issues][22.1.3 Interface Issues]]
  - [[#Debugging][22.2 Debugging]]
    - [[#Enable-Debug-Mode][22.2.1 Enable Debug Mode]]
    - [[#Check-Logs][22.2.2 Check Logs]]
    - [[#Report-Issues][22.2.3 Report Issues]]
- [[#Contributing][23 Contributing]]
  - [[#Getting-Started][23.1 Getting Started]]
  - [[#Development-Setup][23.2 Development Setup]]
    - [[#Required-Tools][23.2.1 Required Tools]]
    - [[#Recommended-Packages][23.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][23.3 Coding Guidelines]]
  - [[#Testing][23.4 Testing]]
    - [[#Run-Existing-Tests][23.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][23.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][23.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][23.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
** 16 Remote Providers [[#Remote-Providers-1][¶]]
:PROPERTIES:
...
*** 16.2 Status Line Indicators [[#Status-Line-Indicators][¶]]
:PROPERTIES:
...
Example: =☁acgks= means cloud model with all five external providers
loaded.

<<Setting-Up-API-Access>>
*** 16.3 Setting Up API Access [[#Setting-Up-API-Access][¶]]
:PROPERTIES:
...
*** 16.4 Selecting Remote Models [[#Selecting-Remote-Models][¶]]
:PROPERTIES:
...
*** 16.5 Provider Configuration [[#Provider-Configuration][¶]]
:PROPERTIES:
...
**** 16.5.1 OpenAI Configuration [[#OpenAI-Configuration][¶]]
:PROPERTIES:
...
**** 16.5.2 Claude Configuration [[#Claude-Configuration][¶]]
:PROPERTIES:
...
**** 16.5.3 Gemini Configuration [[#Gemini-Configuration][¶]]
:PROPERTIES:
...
<<Grok-Configuration>>
**** 16.5.4 Grok Configuration [[#Grok-Configuration][¶]]
:PROPERTIES:
...
**** 16.5.5 Codestral Configuration [[#Codestral-Configuration][¶]]
:PROPERTIES:
...
<<History-Management>>
*** 16.6 History Management [[#History-Management][¶]]
:PROPERTIES:
...
** 17 Ollama Cloud Models [[#Ollama-Cloud-Models-1][¶]]
:PROPERTIES:
...
*** 17.2 Available Cloud Models [[#Available-Cloud-Models][¶]]
:PROPERTIES:
...
*** 17.3 Selecting Cloud Models [[#Selecting-Cloud-Models][¶]]
:PROPERTIES:
...
*** 17.4 Cloud Authentication [[#Cloud-Authentication][¶]]
:PROPERTIES:
...
<<Cloud-Model-Indicator>>
*** 17.5 Cloud Model Indicator [[#Cloud-Model-Indicator][¶]]
:PROPERTIES:
...
<<Configuration-2>>
*** 17.6 Configuration [[#Configuration-2][¶]]
:PROPERTIES:
...
<<Configuration-3>>
*** 18.2 Configuration [[#Configuration-3][¶]]
:PROPERTIES:
:CUSTOM_ID: configuration-1
:CLASS: section
:END:
...
<<How-It-Works>>
*** 18.4 How It Works [[#How-It-Works][¶]]
:PROPERTIES:
...
** 19 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 19.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 19.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 19.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 19.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 19.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 19.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 19.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 19.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
** 20 API Reference [[#API-Reference-1][¶]]
:PROPERTIES:
...
*** 20.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
- =ollama-buddy-display-token-stats= :: Display token usage statistics with graphs and recent interactions.
...
<<Core-Functions>>
*** 20.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 20.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 21.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 21.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 21.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 21.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 21.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 21.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 21.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 21.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 21.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 21.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 21.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 21.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 21.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 21.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 21.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 21.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-1>>
*** 21.3 Troubleshooting [[#Troubleshooting-1][¶]]
:PROPERTIES:
...
**** 21.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 21.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 21.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 21.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 21.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 21.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 21.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 21.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 22 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 22.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 22.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 22.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 22.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 22.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 22.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 23 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Getting-Started>>
*** 23.1 Getting Started [[#Getting-Started][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 23.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 23.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 23.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 23.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 23.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 23.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 23.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 23.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
