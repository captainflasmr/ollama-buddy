...
- [[#Tool-Calling][22 Tool Calling]]
  - [[#Overview-8][22.1 Overview]]
  - [[#Setup][22.2 Setup]]
  - [[#Built_002din-Tools][22.3 Built-in Tools]]
    - [[#Safe-Tools-_0028available-in-safe-mode_0029][22.3.1 Safe Tools
      (available in safe mode)]]
    - [[#Unsafe-Tools-_0028require-safe-mode-off_0029][22.3.2 Unsafe
      Tools (require safe mode off)]]
  - [[#Example-Prompts][22.4 Example Prompts]]
  - [[#How-It-Works-4][22.5 How It Works]]
    - [[#Model-Compatibility][22.5.1 Model Compatibility]]
  - [[#Configuration-7][22.6 Configuration]]
  - [[#Registering-Custom-Tools][22.7 Registering Custom Tools]]
  - [[#Interactive-Commands][22.8 Interactive Commands]]
  - [[#Tool-Indicators][22.9 Tool Indicators]]
- [[#RAG][23 RAG (Retrieval-Augmented Generation)]]
  - [[#Overview-9][23.1 Overview]]
  - [[#Requirements][23.2 Requirements]]
  - [[#Quick-Start-2][23.3 Quick Start]]
  - [[#How-It-Works-5][23.4 How It Works]]
  - [[#Configuration-8][23.5 Configuration]]
  - [[#PDF-Support][23.6 PDF Support]]
  - [[#Interactive-Commands-1][23.7 Interactive Commands]]
  - [[#Inline-_0040rag_0028_0029-Syntax][23.8 Inline @rag() Syntax]]
  - [[#Example-Workflow][23.9 Example Workflow]]
- [[#Advanced-Usage][24 Advanced Usage]]
  - [[#Managing-Token-Usage][24.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][24.2 Customizing the Interface]]
    - [[#Streaming-Options][24.2.1 Streaming Options]]
    - [[#Debug-Mode][24.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][24.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][24.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][24.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][24.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][24.5 Using Direct API Access]]
- [[#API-Reference][25 API Reference]]
  - [[#Interactive-Functions][25.1 Interactive Functions]]
  - [[#Core-Functions][25.2 Core Functions]]
  - [[#Customization-Functions][25.3 Customization Functions]]
- [[#FAQ][26 Frequently Asked Questions]]
  - [[#General-Questions][26.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][26.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][26.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][26.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][26.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][26.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][26.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][26.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][26.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][26.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][26.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][26.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][26.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][26.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][26.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][26.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-2][26.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][26.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][26.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][26.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][26.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][26.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][26.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][26.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][26.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][27 Troubleshooting]]
  - [[#Common-Issues][27.1 Common Issues]]
    - [[#Connection-Problems][27.1.1 Connection Problems]]
    - [[#Model-Problems][27.1.2 Model Problems]]
    - [[#Interface-Issues][27.1.3 Interface Issues]]
  - [[#Debugging][27.2 Debugging]]
    - [[#Enable-Debug-Mode][27.2.1 Enable Debug Mode]]
    - [[#Check-Logs][27.2.2 Check Logs]]
    - [[#Report-Issues][27.2.3 Report Issues]]
- [[#Contributing][28 Contributing]]
  - [[#Getting-Started][28.1 Getting Started]]
  - [[#Development-Setup][28.2 Development Setup]]
    - [[#Required-Tools][28.2.1 Required Tools]]
    - [[#Recommended-Packages][28.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][28.3 Coding Guidelines]]
  - [[#Testing][28.4 Testing]]
    - [[#Run-Existing-Tests][28.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][28.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][28.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][28.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
Next: [[#Tool-Calling][Tool Calling]], Previous: [[#Tone-Selector][Tone
Selector]], Up: [[#Top][Ollama Buddy]]  
[[[#SEC_Contents][Contents]]][[[#Index][Index]]]
...
** 22 Tool Calling [[#Tool-Calling-1][¶]]
:PROPERTIES:
...
<<Built_002din-Tools>>
*** 22.3 Built-in Tools [[#Built_002din-Tools][¶]]
:PROPERTIES:
...
**** 22.3.1 Safe Tools (available in safe mode) [[#Safe-Tools-_0028available-in-safe-mode_0029][¶]]
:PROPERTIES:
...
**** 22.3.2 Unsafe Tools (require safe mode off) [[#Unsafe-Tools-_0028require-safe-mode-off_0029][¶]]
:PROPERTIES:
...
<<Example-Prompts>>
*** 22.4 Example Prompts [[#Example-Prompts][¶]]
:PROPERTIES:
...
<<How-It-Works-4>>
*** 22.5 How It Works [[#How-It-Works-4][¶]]
:PROPERTIES:
...
<<Model-Compatibility>>
**** 22.5.1 Model Compatibility [[#Model-Compatibility][¶]]
:PROPERTIES:
...
<<Configuration-7>>
*** 22.6 Configuration [[#Configuration-7][¶]]
:PROPERTIES:
...
*** 22.7 Registering Custom Tools [[#Registering-Custom-Tools][¶]]
:PROPERTIES:
...
*** 22.8 Interactive Commands [[#Interactive-Commands][¶]]
:PROPERTIES:
...
<<Tool-Indicators>>
*** 22.9 Tool Indicators [[#Tool-Indicators][¶]]
:PROPERTIES:
...
** 23 RAG (Retrieval-Augmented Generation) [[#RAG-_0028Retrieval_002dAugmented-Generation_0029][¶]]
:PROPERTIES:
...
<<Requirements>>
*** 23.2 Requirements [[#Requirements][¶]]
:PROPERTIES:
...
<<Quick-Start-2>>
*** 23.3 Quick Start [[#Quick-Start-2][¶]]
:PROPERTIES:
...
<<How-It-Works-5>>
*** 23.4 How It Works [[#How-It-Works-5][¶]]
:PROPERTIES:
...
<<Configuration-8>>
*** 23.5 Configuration [[#Configuration-8][¶]]
:PROPERTIES:
...
*** 23.7 Interactive Commands [[#Interactive-Commands-1][¶]]
:PROPERTIES:
...
*** 23.8 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 23.9 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
...
** 24 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 24.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 24.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 24.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 24.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 24.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 24.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 24.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 24.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
** 25 API Reference [[#API-Reference-1][¶]]
:PROPERTIES:
...
*** 25.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
<<Core-Functions>>
*** 25.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 25.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 26.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 26.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 26.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 26.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 26.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 26.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 26.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 26.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 26.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 26.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 26.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 26.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 26.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 26.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 26.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 26.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-2>>
*** 26.3 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
**** 26.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 26.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 26.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 26.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 26.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 26.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 26.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 26.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 27 Troubleshooting [[#Troubleshooting-3][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 27.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 27.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 27.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 27.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 27.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 27.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 28 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 28.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 28.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 28.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 28.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 28.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 28.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 28.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 28.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
