...
- [[#Tool-Calling][21 Tool Calling]]
  - [[#Overview-7][21.1 Overview]]
  - [[#Setup][21.2 Setup]]
  - [[#Built_002din-Tools][21.3 Built-in Tools]]
    - [[#Safe-Tools-_0028available-in-safe-mode_0029][21.3.1 Safe Tools
      (available in safe mode)]]
    - [[#Unsafe-Tools-_0028require-safe-mode-off_0029][21.3.2 Unsafe
      Tools (require safe mode off)]]
  - [[#Example-Prompts][21.4 Example Prompts]]
  - [[#How-It-Works-3][21.5 How It Works]]
    - [[#Model-Compatibility][21.5.1 Model Compatibility]]
  - [[#Configuration-6][21.6 Configuration]]
  - [[#Registering-Custom-Tools][21.7 Registering Custom Tools]]
  - [[#Interactive-Commands][21.8 Interactive Commands]]
  - [[#Tool-Indicators][21.9 Tool Indicators]]
- [[#RAG][22 RAG (Retrieval-Augmented Generation)]]
  - [[#Overview-8][22.1 Overview]]
  - [[#Requirements][22.2 Requirements]]
  - [[#Quick-Start-2][22.3 Quick Start]]
  - [[#How-It-Works-4][22.4 How It Works]]
  - [[#Configuration-7][22.5 Configuration]]
  - [[#PDF-Support][22.6 PDF Support]]
  - [[#Interactive-Commands-1][22.7 Interactive Commands]]
  - [[#Inline-_0040rag_0028_0029-Syntax][22.8 Inline @rag() Syntax]]
  - [[#Example-Workflow][22.9 Example Workflow]]
- [[#Advanced-Usage][23 Advanced Usage]]
  - [[#Managing-Token-Usage][23.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][23.2 Customizing the Interface]]
    - [[#Streaming-Options][23.2.1 Streaming Options]]
    - [[#Debug-Mode][23.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][23.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][23.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][23.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][23.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][23.5 Using Direct API Access]]
- [[#API-Reference][24 API Reference]]
  - [[#Interactive-Functions][24.1 Interactive Functions]]
  - [[#Core-Functions][24.2 Core Functions]]
  - [[#Customization-Functions][24.3 Customization Functions]]
- [[#FAQ][25 Frequently Asked Questions]]
  - [[#General-Questions][25.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][25.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][25.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][25.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][25.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][25.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][25.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][25.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][25.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][25.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][25.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][25.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][25.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][25.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][25.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][25.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-2][25.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][25.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][25.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][25.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][25.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][25.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][25.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][25.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][25.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][26 Troubleshooting]]
  - [[#Common-Issues][26.1 Common Issues]]
    - [[#Connection-Problems][26.1.1 Connection Problems]]
    - [[#Model-Problems][26.1.2 Model Problems]]
    - [[#Interface-Issues][26.1.3 Interface Issues]]
  - [[#Debugging][26.2 Debugging]]
    - [[#Enable-Debug-Mode][26.2.1 Enable Debug Mode]]
    - [[#Check-Logs][26.2.2 Check Logs]]
    - [[#Report-Issues][26.2.3 Report Issues]]
- [[#Contributing][27 Contributing]]
  - [[#Getting-Started][27.1 Getting Started]]
  - [[#Development-Setup][27.2 Development Setup]]
    - [[#Required-Tools][27.2.1 Required Tools]]
    - [[#Recommended-Packages][27.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][27.3 Coding Guidelines]]
  - [[#Testing][27.4 Testing]]
    - [[#Run-Existing-Tests][27.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][27.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][27.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][27.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
- =@search(query)= :: Search the web and attach results (requires
  =ollama-buddy-web-search=).

- =@rag(query)= :: Search a RAG index and attach results (requires
  =ollama-buddy-rag=).

- =@file(path)= :: Attach a file to the conversation context.

- Outside the prompt area, =@= inserts a literal ‘=@='.
- Press =C-g= to cancel and insert a literal ‘=@='.
...
** 21 Tool Calling [[#Tool-Calling-1][¶]]
:PROPERTIES:
...
<<Built_002din-Tools>>
*** 21.3 Built-in Tools [[#Built_002din-Tools][¶]]
:PROPERTIES:
...
**** 21.3.1 Safe Tools (available in safe mode) [[#Safe-Tools-_0028available-in-safe-mode_0029][¶]]
:PROPERTIES:
...
**** 21.3.2 Unsafe Tools (require safe mode off) [[#Unsafe-Tools-_0028require-safe-mode-off_0029][¶]]
:PROPERTIES:
...
<<Example-Prompts>>
*** 21.4 Example Prompts [[#Example-Prompts][¶]]
:PROPERTIES:
...
<<How-It-Works-3>>
*** 21.5 How It Works [[#How-It-Works-3][¶]]
:PROPERTIES:
...
<<Model-Compatibility>>
**** 21.5.1 Model Compatibility [[#Model-Compatibility][¶]]
:PROPERTIES:
...
<<Configuration-6>>
*** 21.6 Configuration [[#Configuration-6][¶]]
:PROPERTIES:
...
*** 21.7 Registering Custom Tools [[#Registering-Custom-Tools][¶]]
:PROPERTIES:
...
*** 21.8 Interactive Commands [[#Interactive-Commands][¶]]
:PROPERTIES:
:CUSTOM_ID: interactive-commands
:CLASS: section
:END:
- =ollama-buddy-tools-toggle (==C-c W==)= :: Toggle tool calling on or
...
<<Tool-Indicators>>
*** 21.9 Tool Indicators [[#Tool-Indicators][¶]]
:PROPERTIES:
...
- Header line :: Shows =⚒= when tool calling is currently /enabled/
  (toggled on with C-c W). This indicates that tool calls will be sent
  to the model.
...
- The header line shows =⚒= only when you've enabled tools with C-c W
...
** 22 RAG (Retrieval-Augmented Generation) [[#RAG-_0028Retrieval_002dAugmented-Generation_0029][¶]]
:PROPERTIES:
...
The RAG module is provided by =ollama-buddy-rag.el=.

<<Requirements>>
*** 22.2 Requirements [[#Requirements][¶]]
:PROPERTIES:
...
<<Quick-Start-2>>
*** 22.3 Quick Start [[#Quick-Start-2][¶]]
:PROPERTIES:
...
<<How-It-Works-4>>
*** 22.4 How It Works [[#How-It-Works-4][¶]]
:PROPERTIES:
...
<<Configuration-7>>
*** 22.5 Configuration [[#Configuration-7][¶]]
:PROPERTIES:
...
*** 22.7 Interactive Commands [[#Interactive-Commands-1][¶]]
:PROPERTIES:
...
*** 22.8 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 22.9 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
...
** 23 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 23.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 23.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 23.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 23.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 23.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 23.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 23.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 23.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
** 24 API Reference [[#API-Reference-1][¶]]
:PROPERTIES:
...
*** 24.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
<<Core-Functions>>
*** 24.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 24.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 25.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 25.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 25.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 25.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 25.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 25.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 25.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 25.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 25.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 25.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 25.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 25.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 25.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 25.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 25.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 25.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-2>>
*** 25.3 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
**** 25.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 25.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 25.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 25.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 25.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 25.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 25.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 25.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 26 Troubleshooting [[#Troubleshooting-3][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 26.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 26.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 26.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 26.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 26.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 26.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 27 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Getting-Started>>
*** 27.1 Getting Started [[#Getting-Started][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 27.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 27.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 27.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 27.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 27.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 27.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 27.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 27.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
