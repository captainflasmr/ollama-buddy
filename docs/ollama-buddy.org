...
- [[#Tool-Calling][24 Tool Calling]]
  ...
  - [[#Configuration-7][24.6 Configuration]]
...
- [[#RAG][25 RAG (Retrieval-Augmented Generation)]]
  - [[#Overview-10][25.1 Overview]]
  - [[#Requirements][25.2 Requirements]]
  - [[#Quick-Start-2][25.3 Quick Start]]
  - [[#How-It-Works-5][25.4 How It Works]]
  - [[#Configuration-8][25.5 Configuration]]
  - [[#PDF-Support][25.6 PDF Support]]
  - [[#Interactive-Commands-1][25.7 Interactive Commands]]
  - [[#Inline-_0040rag_0028_0029-Syntax][25.8 Inline @rag() Syntax]]
  - [[#Example-Workflow][25.9 Example Workflow]]
- [[#Advanced-Usage][26 Advanced Usage]]
  - [[#Managing-Token-Usage][26.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][26.2 Customizing the Interface]]
    - [[#Streaming-Options][26.2.1 Streaming Options]]
    - [[#Debug-Mode][26.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][26.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][26.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][26.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][26.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][26.5 Using Direct API Access]]
- [[#API-Reference][27 API Reference]]
  - [[#Interactive-Functions][27.1 Interactive Functions]]
  - [[#Core-Functions][27.2 Core Functions]]
  - [[#Customization-Functions][27.3 Customization Functions]]
- [[#FAQ][28 Frequently Asked Questions]]
  - [[#General-Questions][28.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][28.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][28.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][28.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][28.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][28.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][28.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][28.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][28.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][28.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][28.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][28.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][28.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][28.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][28.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][28.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-2][28.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][28.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][28.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][28.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][28.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][28.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][28.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][28.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][28.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][29 Troubleshooting]]
  - [[#Common-Issues][29.1 Common Issues]]
    - [[#Connection-Problems][29.1.1 Connection Problems]]
    - [[#Model-Problems][29.1.2 Model Problems]]
    - [[#Interface-Issues][29.1.3 Interface Issues]]
  - [[#Debugging][29.2 Debugging]]
    - [[#Enable-Debug-Mode][29.2.1 Enable Debug Mode]]
    - [[#Check-Logs][29.2.2 Check Logs]]
    - [[#Report-Issues][29.2.3 Report Issues]]
- [[#Contributing][30 Contributing]]
  - [[#Getting-Started][30.1 Getting Started]]
  - [[#Development-Setup][30.2 Development Setup]]
    - [[#Required-Tools][30.2.1 Required Tools]]
    - [[#Recommended-Packages][30.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][30.3 Coding Guidelines]]
  - [[#Testing][30.4 Testing]]
    - [[#Run-Existing-Tests][30.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][30.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][30.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][30.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
- Toggling thinking stream visibility :: Press =C-c V= to toggle live
  display of thinking tokens as they stream in. A =◐= indicator appears
  in the header line when active.
...
- Using Fabric patterns :: Select text, press =C-c O=, then =y= for the
  System Prompts menu, then =f= for Fabric.
...
- =◐= - Thinking stream visibility is on (thinking tokens shown live)
...
Example: =☁⚒⊙✦◐≡2♁1acgkpsdr= means cloud model with tools enabled,
vision support, thinking support with visible streaming, 2 file
attachments, 1 web search, and all eight external providers loaded.
...
:CLASS: section
:END:
- C-c V :: Toggle thinking stream visibility for the next incoming
  thinking block. When enabled, thinking tokens are displayed live under
  the =*** ✦ Think= heading as they arrive, then replaced with converted
  org content and folded on completion. A =◐= indicator appears in the
  header line when active.
...
- =ollama-buddy-stream-thinking-visible= :: When non-nil, thinking
  tokens are displayed in the buffer as they stream in. On completion
  the raw text is replaced with converted org content and the heading is
  folded. Toggle with =C-c V=.
...
<<Configuration-7>>
*** 24.6 Configuration [[#Configuration-7][¶]]
:PROPERTIES:
...
** 25 RAG (Retrieval-Augmented Generation) [[#RAG-_0028Retrieval_002dAugmented-Generation_0029][¶]]
:PROPERTIES:
...
<<Requirements>>
*** 25.2 Requirements [[#Requirements][¶]]
:PROPERTIES:
...
<<Quick-Start-2>>
*** 25.3 Quick Start [[#Quick-Start-2][¶]]
:PROPERTIES:
...
<<How-It-Works-5>>
*** 25.4 How It Works [[#How-It-Works-5][¶]]
:PROPERTIES:
...
<<Configuration-8>>
*** 25.5 Configuration [[#Configuration-8][¶]]
:PROPERTIES:
...
*** 25.7 Interactive Commands [[#Interactive-Commands-1][¶]]
:PROPERTIES:
...
*** 25.8 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 25.9 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
...
** 26 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 26.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 26.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 26.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 26.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 26.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 26.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 26.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 26.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
** 27 API Reference [[#API-Reference-1][¶]]
:PROPERTIES:
...
*** 27.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
- =ollama-buddy-toggle-reasoning-visibility= :: Toggle thinking stream
  visibility. When enabled, thinking tokens are shown live as they
  stream in.
...
<<Core-Functions>>
*** 27.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 27.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 28.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 28.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 28.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 28.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 28.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 28.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 28.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 28.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 28.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 28.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 28.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 28.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 28.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 28.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 28.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 28.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-2>>
*** 28.3 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
**** 28.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 28.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 28.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 28.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 28.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 28.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 28.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 28.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 29 Troubleshooting [[#Troubleshooting-3][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 29.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 29.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 29.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 29.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 29.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 29.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 30 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 30.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 30.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 30.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 30.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 30.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 30.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 30.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 30.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
