...
- [[#Session-Management][12 Session Management]]
  ...
  - [[#Renaming-a-Session][12.7 Renaming a Session]]
  - [[#Session-Directory-Persistence][12.8 Session Directory
    Persistence]]
  - [[#Autosave-Transcript][12.9 Autosave Transcript]]
  - [[#Conversation-History][12.10 Conversation History]]
  - [[#Rewinding-a-Conversation][12.11 Rewinding a Conversation]]
...
<<Renaming-a-Session>>
*** 12.7 Renaming a Session [[#Renaming-a-Session][¶]]
:PROPERTIES:
...
*** 12.8 Session Directory Persistence [[#Session-Directory-Persistence][¶]]
:PROPERTIES:
...
<<Autosave-Transcript>>
*** 12.9 Autosave Transcript [[#Autosave-Transcript][¶]]
:PROPERTIES:
...
*** 12.10 Conversation History [[#Conversation-History][¶]]
:PROPERTIES:
...
*** 12.11 Rewinding a Conversation [[#Rewinding-a-Conversation][¶]]
:PROPERTIES:
...
(session and weekly percentages) in the Cloud Models section. The header
line also shows compact usage percentages (e.g. =45% 32%= for session
and weekly) when a cloud model is selected.
...
- =ollama-buddy-rag-list-indices (==w==)= :: List all saved RAG indices
