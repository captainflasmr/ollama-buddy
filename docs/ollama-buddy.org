...
- [[#Tool-Calling][21 Tool Calling]]
  ...
  - [[#Tool_002dCapable-Model-Indicator][21.9 Tool-Capable Model
    Indicator]]
- [[#Advanced-Usage][22 Advanced Usage]]
  - [[#Managing-Token-Usage][22.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][22.2 Customizing the Interface]]
    - [[#Streaming-Options][22.2.1 Streaming Options]]
    - [[#Debug-Mode][22.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][22.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][22.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][22.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][22.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][22.5 Using Direct API Access]]
- [[#API-Reference][23 API Reference]]
  - [[#Interactive-Functions][23.1 Interactive Functions]]
  - [[#Core-Functions][23.2 Core Functions]]
  - [[#Customization-Functions][23.3 Customization Functions]]
- [[#FAQ][24 Frequently Asked Questions]]
  - [[#General-Questions][24.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][24.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][24.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][24.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][24.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][24.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][24.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][24.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][24.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][24.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][24.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][24.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][24.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][24.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][24.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][24.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-2][24.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][24.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][24.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][24.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][24.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][24.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][24.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][24.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][24.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][25 Troubleshooting]]
  - [[#Common-Issues][25.1 Common Issues]]
    - [[#Connection-Problems][25.1.1 Connection Problems]]
    - [[#Model-Problems][25.1.2 Model Problems]]
    - [[#Interface-Issues][25.1.3 Interface Issues]]
  - [[#Debugging][25.2 Debugging]]
    - [[#Enable-Debug-Mode][25.2.1 Enable Debug Mode]]
    - [[#Check-Logs][25.2.2 Check Logs]]
    - [[#Report-Issues][25.2.3 Report Issues]]
- [[#Contributing][26 Contributing]]
  - [[#Getting-Started][26.1 Getting Started]]
  - [[#Development-Setup][26.2 Development Setup]]
    - [[#Required-Tools][26.2.1 Required Tools]]
    - [[#Recommended-Packages][26.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][26.3 Coding Guidelines]]
  - [[#Testing][26.4 Testing]]
    - [[#Run-Existing-Tests][26.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][26.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][26.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][26.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
- [[#Tool_002dCapable-Model-Indicator][Tool-Capable Model Indicator]]
...
:CLASS: section
:END:
- =ollama-buddy-tools-toggle= :: Toggle tool calling on or off.

- =ollama-buddy-tools-toggle-safe-mode= :: Toggle safe mode for tool
  execution.

- =ollama-buddy-tools-info= :: Display information about all registered
  tools in a dedicated buffer, showing status, safe mode, and each
  tool's description.
...
<<Tool_002dCapable-Model-Indicator>>
*** 21.9 Tool-Capable Model Indicator [[#Tool_002dCapable-Model-Indicator][¶]]
:PROPERTIES:
:CUSTOM_ID: tool-capable-model-indicator
:CLASS: section
:END:
Models known to support tool calling show a =⚒= indicator in:

- The header line when the current model supports tools
...
Next: [[#API-Reference][API Reference]], Previous: [[#Tool-Calling][Tool
Calling]], Up: [[#Top][Ollama Buddy]]  
[[[#SEC_Contents][Contents]]][[[#Index][Index]]]

** 22 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 22.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 22.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 22.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 22.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 22.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 22.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 22.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 22.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
** 23 API Reference [[#API-Reference-1][¶]]
:PROPERTIES:
...
*** 23.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
<<Core-Functions>>
*** 23.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 23.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 24.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 24.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 24.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 24.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 24.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 24.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 24.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 24.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 24.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 24.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 24.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 24.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 24.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 24.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 24.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 24.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-2>>
*** 24.3 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
**** 24.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 24.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 24.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 24.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 24.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 24.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 24.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 24.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 25 Troubleshooting [[#Troubleshooting-3][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 25.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 25.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 25.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 25.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 25.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 25.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 26 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Getting-Started>>
*** 26.1 Getting Started [[#Getting-Started][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 26.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 26.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 26.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 26.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 26.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 26.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 26.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 26.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
