...
- =ollama-buddy-cloud-models-url= :: URL for fetching available cloud
  models (default: =https://ollama.com/api/tags=).  The model list is
  populated automatically on first access; use =M-x
  ollama-buddy-cloud-sync-models= or =/sync= to force a refresh.
...
:CLASS: section
:END:
Cloud models are discovered automatically from =ollama-buddy-cloud-models-url= on first access.  The list is session-cached; use =M-x ollama-buddy-cloud-sync-models= or =/sync= to force a refresh.

#+begin_src example-preformatted
M-x ollama-buddy-cloud-sync-models
#+end_src
...
:CLASS: section
:END:
- =ollama-buddy-cloud-models-url= :: URL for fetching available Ollama
  cloud models (default: =https://ollama.com/api/tags=).
