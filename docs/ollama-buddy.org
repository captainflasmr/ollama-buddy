...
- [[#Core-Features][5 Core Features]]
  ...
  - [[#Prompt-Template-Collections][5.7 Prompt Template Collections]]
  - [[#External-API-Integration][5.8 External API Integration]]
  - [[#Vision-Support][5.9 Vision Support]]
  - [[#File-Attachments-1][5.10 File Attachments]]
...
- [[#Session-Management][12 Session Management]]
  ...
  - [[#Session-Naming][12.6 Session Naming]]
  - [[#Autosave-Transcript][12.7 Autosave Transcript]]
  - [[#Conversation-History][12.8 Conversation History]]
...
- [[#Roles-and-Commands][14 Roles and Commands]]
  ...
  - [[#Switching-Roles][14.6 Switching Roles]]
  - [[#Managing-Role-Files][14.7 Managing Role Files]]
  - [[#Advanced-Role-Customization][14.8 Advanced Role Customization]]
    - [[#Per_002dRole-Menu-Columns][14.8.1 Per-Role Menu Columns]]
    - [[#Command_002dSpecific-Models][14.8.2 Command-Specific Models]]
    - [[#Command_002dSpecific-Parameters-1][14.8.3 Command-Specific
      Parameters]]
    - [[#Creating-New-Commands][14.8.4 Creating New Commands]]
  - [[#Role-Examples][14.9 Role Examples]]
    - [[#Programming-Role][14.9.1 Programming Role]]
    - [[#Writing-Role][14.9.2 Writing Role]]
  - [[#Tips-for-Effective-Role-Usage][14.10 Tips for Effective Role
    Usage]]
  - [[#Built_002din-Role-Presets][14.11 Built-in Role Presets]]
...
- [[#Ollama-Cloud-Models][18 Ollama Cloud Models]]
  ...
  - [[#Automatic-Manifest-Pulling][18.5 Automatic Manifest Pulling]]
  - [[#Cloud-Model-Indicator][18.6 Cloud Model Indicator]]
  - [[#Configuration-3][18.7 Configuration]]
...
- [[#Tone-Selector][20 Tone Selector]]
  - [[#Overview-6][20.1 Overview]]
  - [[#Usage-1][20.2 Usage]]
  - [[#Built_002din-Tones][20.3 Built-in Tones]]
  - [[#Configuration-5][20.4 Configuration]]
  - [[#How-It-Works-2][20.5 How It Works]]
- [[#Thinking-Blocks][21 Thinking Blocks]]
  - [[#Overview-7][21.1 Overview]]
  - [[#How-It-Works-3][21.2 How It Works]]
  - [[#Key-Bindings][21.3 Key Bindings]]
  - [[#Configuration-6][21.4 Configuration]]
- [[#In_002dBuffer-Replace][22 In-Buffer Replace]]
  - [[#Overview-8][22.1 Overview]]
  - [[#Enabling-In_002dBuffer-Replace][22.2 Enabling In-Buffer Replace]]
  - [[#Workflow][22.3 Workflow]]
  - [[#Key-Bindings-_0028while-rewrite-is-pending_0029][22.4 Key
    Bindings (while rewrite is pending)]]
  - [[#Implementation-Notes][22.5 Implementation Notes]]
  - [[#Current-Limitations][22.6 Current Limitations]]
- [[#Tool-Calling][23 Tool Calling]]
  - [[#Overview-9][23.1 Overview]]
  - [[#Setup][23.2 Setup]]
  - [[#Built_002din-Tools][23.3 Built-in Tools]]
    - [[#Safe-Tools-_0028available-in-safe-mode_0029][23.3.1 Safe Tools
      (available in safe mode)]]
    - [[#Unsafe-Tools-_0028require-safe-mode-off_0029][23.3.2 Unsafe
      Tools (require safe mode off)]]
  - [[#Example-Prompts][23.4 Example Prompts]]
  - [[#How-It-Works-4][23.5 How It Works]]
    - [[#Model-Compatibility][23.5.1 Model Compatibility]]
  - [[#Configuration-7][23.6 Configuration]]
  - [[#Registering-Custom-Tools][23.7 Registering Custom Tools]]
  - [[#Interactive-Commands][23.8 Interactive Commands]]
  - [[#Tool-Indicators][23.9 Tool Indicators]]
- [[#RAG][24 RAG (Retrieval-Augmented Generation)]]
  - [[#Overview-10][24.1 Overview]]
  - [[#Requirements][24.2 Requirements]]
  - [[#Quick-Start-2][24.3 Quick Start]]
  - [[#How-It-Works-5][24.4 How It Works]]
  - [[#Configuration-8][24.5 Configuration]]
  - [[#PDF-Support][24.6 PDF Support]]
  - [[#Interactive-Commands-1][24.7 Interactive Commands]]
  - [[#Inline-_0040rag_0028_0029-Syntax][24.8 Inline @rag() Syntax]]
  - [[#Example-Workflow][24.9 Example Workflow]]
- [[#Advanced-Usage][25 Advanced Usage]]
  - [[#Managing-Token-Usage][25.1 Managing Token Usage]]
  - [[#Customizing-the-Interface][25.2 Customizing the Interface]]
    - [[#Streaming-Options][25.2.1 Streaming Options]]
    - [[#Debug-Mode][25.2.2 Debug Mode]]
  - [[#Editing-Conversation-History][25.3 Editing Conversation History]]
  - [[#Advanced-System-Prompt-Management][25.4 Advanced System Prompt
    Management]]
    - [[#Setting-a-system-prompt-without-sending][25.4.1 Setting a
      system prompt without sending]]
    - [[#Using-a-system-prompt-from-Fabric][25.4.2 Using a system prompt
      from Fabric]]
  - [[#Using-Direct-API-Access][25.5 Using Direct API Access]]
- [[#API-Reference][26 API Reference]]
  - [[#Interactive-Functions][26.1 Interactive Functions]]
  - [[#Core-Functions][26.2 Core Functions]]
  - [[#Customization-Functions][26.3 Customization Functions]]
- [[#FAQ][27 Frequently Asked Questions]]
  - [[#General-Questions][27.1 General Questions]]
    - [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][27.1.1
      What is the difference between Ollama Buddy and other AI
      assistants?]]
    - [[#Does-Ollama-Buddy-require-an-internet-connection_003f][27.1.2
      Does Ollama Buddy require an internet connection?]]
    - [[#How-do-I-use-Ollama-cloud-models_003f][27.1.3 How do I use
      Ollama cloud models?]]
    - [[#Which-models-work-best-with-Ollama-Buddy_003f][27.1.4 Which
      models work best with Ollama Buddy?]]
    - [[#How-much-RAM-do-I-need_003f][27.1.5 How much RAM do I need?]]
  - [[#Usage-Questions][27.2 Usage Questions]]
    - [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][27.2.1
      How do I cancel a request that's taking too long?]]
    - [[#How-can-I-save-my-conversations_003f][27.2.2 How can I save my
      conversations?]]
    - [[#Can-I-use-multiple-models-in-the-same-conversation_003f][27.2.3
      Can I use multiple models in the same conversation?]]
    - [[#How-do-I-clear-the-conversation-history_003f][27.2.4 How do I
      clear the conversation history?]]
    - [[#How-can-I-create-a-custom-command_003f][27.2.5 How can I create
      a custom command?]]
    - [[#How-can-I-manage-context-windows_003f][27.2.6 How can I manage
      context windows?]]
    - [[#What-happens-when-I-exceed-the-context-limit_003f][27.2.7 What
      happens when I exceed the context limit?]]
    - [[#How-do-I-create-effective-system-prompts_003f][27.2.8 How do I
      create effective system prompts?]]
    - [[#Where-are-my-system-prompts-stored_003f][27.2.9 Where are my
      system prompts stored?]]
  - [[#Troubleshooting-2][27.3 Troubleshooting]]
    - [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][27.3.1 Ollama
      Buddy shows "OFFLINE" status]]
    - [[#Responses-are-slow-or-the-model-seems-to-hang][27.3.2 Responses
      are slow or the model seems to hang]]
    - [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][27.3.3
      Getting "error parsing model" when pulling a model]]
    - [[#Model-responses-are-low-quality-or-truncated][27.3.4 Model
      responses are low quality or truncated]]
    - [[#How-do-system-prompts-differ-from-regular-prompts_003f][27.3.5
      How do system prompts differ from regular prompts?]]
    - [[#What-is-the-global-system-prompt_003f][27.3.6 What is the
      global system prompt?]]
    - [[#How-do-I-use-image-analysis_002fvision-features_003f][27.3.7
      How do I use image analysis/vision features?]]
    - [[#Can-I-share-system-prompts-between-different-installations_003f][27.3.8
      Can I share system prompts between different installations?]]
- [[#Troubleshooting][28 Troubleshooting]]
  - [[#Common-Issues][28.1 Common Issues]]
    - [[#Connection-Problems][28.1.1 Connection Problems]]
    - [[#Model-Problems][28.1.2 Model Problems]]
    - [[#Interface-Issues][28.1.3 Interface Issues]]
  - [[#Debugging][28.2 Debugging]]
    - [[#Enable-Debug-Mode][28.2.1 Enable Debug Mode]]
    - [[#Check-Logs][28.2.2 Check Logs]]
    - [[#Report-Issues][28.2.3 Report Issues]]
- [[#Contributing][29 Contributing]]
  - [[#Getting-Started][29.1 Getting Started]]
  - [[#Development-Setup][29.2 Development Setup]]
    - [[#Required-Tools][29.2.1 Required Tools]]
    - [[#Recommended-Packages][29.2.2 Recommended Packages]]
  - [[#Coding-Guidelines][29.3 Coding Guidelines]]
  - [[#Testing][29.4 Testing]]
    - [[#Run-Existing-Tests][29.4.1 Run Existing Tests]]
    - [[#Adding-New-Tests][29.4.2 Adding New Tests]]
  - [[#Feature-Requests-and-Bug-Reports][29.5 Feature Requests and Bug
    Reports]]
    - [[#User-System-Prompts-Issues][29.5.1 User System Prompts Issues]]
- [[#Index][Index]]
...
- =ollama-buddy-full-welcome-enabled= :: Whether to show the full
  welcome screen with all keybinding hints (default: t). When nil, only
  the essential keybindings are shown.
...
- When external providers are loaded :: Prefixes disambiguate providers:
  ...
  - =cl:= - Ollama cloud (e.g., =cl:qwen3-coder:480b-cloud=)
...
- Changing models :: Press =C-c m= to switch between available models.
  Cloud models appear in the list marked with =☁=.
...
*** 5.7 Prompt Template Collections [[#Prompt-Template-Collections][¶]]
:PROPERTIES:
...
*** 5.8 External API Integration [[#External-API-Integration][¶]]
:PROPERTIES:
...
<<Vision-Support>>
*** 5.9 Vision Support [[#Vision-Support][¶]]
:PROPERTIES:
...
<<File-Attachments-1>>
*** 5.10 File Attachments [[#File-Attachments-1][¶]]
:PROPERTIES:
...
- =fabric= :: Load a Fabric pattern as system prompt
  (=ollama-buddy-fabric-set-system-prompt=). Requires
  =ollama-buddy-fabric=.

- =awesome= :: Load an Awesome ChatGPT prompt as system prompt
  (=ollama-buddy-awesome-set-system-prompt=). Requires
...
- Resetting the system prompt :: Press =C-c C-r=, or use the main
  transient menu (C-c O) under System Prompts =C-r=
...
- Browse cloud models (=cl:= prefix) with Select and Pull Manifest
  actions
- Browse and install recommended models organized by category (General
  Chat, Reasoning, Efficient & Capable, Coding, General Alternatives)

Each recommended model category includes a description to help new users
choose the right type of model for their needs. Categories are displayed
as foldable org subheadings so you can collapse sections you are not
interested in.
...
You can also select from the “Recommended Models” list at the bottom,
which shows curated popular models that can be pulled with a single
click.
...
<<Session-Naming>>
*** 12.6 Session Naming [[#Session-Naming][¶]]
:PROPERTIES:
...
characters), then joining up to 5 remaining key terms with hyphens.

For example, a conversation starting with “Tell me about the history of
space exploration” would generate the session name
=tell-history-space-exploration=.

<<Autosave-Transcript>>
*** 12.7 Autosave Transcript [[#Autosave-Transcript][¶]]
:PROPERTIES:
...
*** 12.8 Conversation History [[#Conversation-History][¶]]
:PROPERTIES:
...
<<Switching-Roles>>
*** 14.6 Switching Roles [[#Switching-Roles][¶]]
:PROPERTIES:
...
<<Managing-Role-Files>>
*** 14.7 Managing Role Files [[#Managing-Role-Files][¶]]
:PROPERTIES:
...
*** 14.8 Advanced Role Customization [[#Advanced-Role-Customization][¶]]
:PROPERTIES:
...
**** 14.8.1 Per-Role Menu Columns [[#Per_002dRole-Menu-Columns][¶]]
:PROPERTIES:
...
**** 14.8.2 Command-Specific Models [[#Command_002dSpecific-Models][¶]]
:PROPERTIES:
...
**** 14.8.3 Command-Specific Parameters [[#Command_002dSpecific-Parameters-1][¶]]
:PROPERTIES:
...
**** 14.8.4 Creating New Commands [[#Creating-New-Commands][¶]]
:PROPERTIES:
...
<<Role-Examples>>
*** 14.9 Role Examples [[#Role-Examples][¶]]
:PROPERTIES:
...
<<Programming-Role>>
**** 14.9.1 Programming Role [[#Programming-Role][¶]]
:PROPERTIES:
...
<<Writing-Role>>
**** 14.9.2 Writing Role [[#Writing-Role][¶]]
:PROPERTIES:
...
*** 14.10 Tips for Effective Role Usage [[#Tips-for-Effective-Role-Usage][¶]]
:PROPERTIES:
...
*** 14.11 Built-in Role Presets [[#Built_002din-Role-Presets][¶]]
:PROPERTIES:
...
- =⚒= - Current model supports tool calling
- =≡N= - Number of file attachments
- =♁N= - Number of web search results attached
- =V= - Reasoning/thinking sections hidden
- =T= - Token statistics display enabled

Example: =☁⚒≡2♁1= means cloud model with tool support, 2 file
attachments and 1 web search attached.
...
Cloud models are displayed with a =cl:= prefix (e.g.
=cl:deepseek-v3.1:671b-cloud=) to distinguish them from local models.
The Model Management page also shows the current cloud authentication
status next to the section heading.
...
*** 18.5 Automatic Manifest Pulling [[#Automatic-Manifest-Pulling][¶]]
:PROPERTIES:
...
*** 18.6 Cloud Model Indicator [[#Cloud-Model-Indicator][¶]]
:PROPERTIES:
...
<<Configuration-3>>
*** 18.7 Configuration [[#Configuration-3][¶]]
:PROPERTIES:
:CUSTOM_ID: configuration-1
:CLASS: section
:END:
...
<<Configuration-5>>
*** 20.4 Configuration [[#Configuration-5][¶]]
:PROPERTIES:
...
The =✦= symbol appears in the header line and prompt line whenever the
active model supports thinking/reasoning.
...
:CLASS: section
:END:
- C-c V :: Toggle all thinking blocks in the buffer --- expands any that
  are folded, or folds all if they are all expanded.

- TAB :: On a =*** ✦ Think= heading line, cycle visibility of that
  individual block (standard org-mode behavior).

<<Configuration-6>>
*** 21.4 Configuration [[#Configuration-6][¶]]
:PROPERTIES:
...
** 22 In-Buffer Replace [[#In_002dBuffer-Replace-1][¶]]
:PROPERTIES:
...
<<Overview-8>>
*** 22.1 Overview [[#Overview-8][¶]]
:PROPERTIES:
:CUSTOM_ID: overview-8
:CLASS: section
:END:
In-buffer replace is an /initial pass/ at a feature that streams LLM
output directly into the source buffer rather than the chat buffer. When
active, commands that operate on a selected region (such as Refactor,
Proofread, or any custom role command) will replace the selection
in-place with the model's response.

This is an early-stage capability. The existing chat buffer workflow is
completely unchanged when the toggle is off (the default), and all
existing commands, prompts, system prompts, and model selection logic
are unaffected --- only the output destination changes.

<<Enabling-In_002dBuffer-Replace>>
*** 22.2 Enabling In-Buffer Replace [[#Enabling-In_002dBuffer-Replace][¶]]
:PROPERTIES:
:CUSTOM_ID: enabling-in-buffer-replace
:CLASS: section
:END:
Toggle via the transient menu (=C-c O=) ‘=Actions=' section, key W:
...
<<Workflow>>
*** 22.3 Workflow [[#Workflow][¶]]
:PROPERTIES:
:CUSTOM_ID: workflow
:CLASS: section
:END:
1. Toggle in-buffer replace on (W in the transient Actions menu).
...
4. A dimmed ‘=[Rewriting...]=' placeholder replaces the selection.
5. The model's response streams in with a green highlight.
6. When streaming finishes, a minor mode activates. The mode line shows
   ‘= [Rewrite?]='.
...
*** 22.4 Key Bindings (while rewrite is pending) [[#Key-Bindings-_0028while-rewrite-is-pending_0029][¶]]
:PROPERTIES:
...
*** 22.5 Implementation Notes [[#Implementation-Notes][¶]]
:PROPERTIES:
...
- A /non-advancing/ start marker (stays before inserted text).
- An /advancing/ end marker (moves past each newly inserted chunk).

Original text is preserved in memory for rejection; no undo history
manipulation is required.

<<Current-Limitations>>
*** 22.6 Current Limitations [[#Current-Limitations][¶]]
:PROPERTIES:
:CUSTOM_ID: current-limitations
:CLASS: section
:END:
This is an initial implementation. Known limitations for future work:
...
- The streaming response is inserted verbatim; no markdown-to-org
  conversion is performed (unlike the chat buffer).
...
** 23 Tool Calling [[#Tool-Calling-1][¶]]
:PROPERTIES:
...
<<Built_002din-Tools>>
*** 23.3 Built-in Tools [[#Built_002din-Tools][¶]]
:PROPERTIES:
...
**** 23.3.1 Safe Tools (available in safe mode) [[#Safe-Tools-_0028available-in-safe-mode_0029][¶]]
:PROPERTIES:
...
**** 23.3.2 Unsafe Tools (require safe mode off) [[#Unsafe-Tools-_0028require-safe-mode-off_0029][¶]]
:PROPERTIES:
...
<<Example-Prompts>>
*** 23.4 Example Prompts [[#Example-Prompts][¶]]
:PROPERTIES:
...
<<How-It-Works-4>>
*** 23.5 How It Works [[#How-It-Works-4][¶]]
:PROPERTIES:
...
<<Model-Compatibility>>
**** 23.5.1 Model Compatibility [[#Model-Compatibility][¶]]
:PROPERTIES:
...
<<Configuration-7>>
*** 23.6 Configuration [[#Configuration-7][¶]]
:PROPERTIES:
...
*** 23.7 Registering Custom Tools [[#Registering-Custom-Tools][¶]]
:PROPERTIES:
...
*** 23.8 Interactive Commands [[#Interactive-Commands][¶]]
:PROPERTIES:
...
<<Tool-Indicators>>
*** 23.9 Tool Indicators [[#Tool-Indicators][¶]]
:PROPERTIES:
...
=cl:qwen3-coder:480b-cloud=) are automatically matched against their
base names.
...
** 24 RAG (Retrieval-Augmented Generation) [[#RAG-_0028Retrieval_002dAugmented-Generation_0029][¶]]
:PROPERTIES:
...
:CLASS: section
:END:
RAG requires an embedding model pulled into Ollama:

#+begin_src example-preformatted
ollama pull nomic-embed-text
#+end_src

Other supported embedding models include =mxbai-embed-large= and
=all-minilm=. You can pull these from Model Management (C-c M) under the
“Embedding (RAG)” category.

<<Quick-Start-2>>
*** 24.3 Quick Start [[#Quick-Start-2][¶]]
:PROPERTIES:
...
<<Configuration-8>>
*** 24.5 Configuration [[#Configuration-8][¶]]
:PROPERTIES:
...
*** 24.7 Interactive Commands [[#Interactive-Commands-1][¶]]
:PROPERTIES:
...
- =ollama-buddy-rag-index-directory-interactive (==i==)= :: Index a
  directory. Prompts for the directory path, reads and chunks all
  matching files, then asynchronously generates embeddings. Progress is
  shown in the status line.

- =ollama-buddy-rag-search-interactive (==s==)= :: Search the index with
  a text query. Results are displayed in an org-mode buffer showing
  similarity scores, file paths, and content excerpts.

- =ollama-buddy-rag-attach-context (==a==)= :: Search and attach the top
  results as context for the next conversation. Attached RAG context
  appears when you use Show Attachments.

- =ollama-buddy-rag-list-indices (==l==)= :: List all saved RAG indices
  with their chunk counts and file counts.

- =ollama-buddy-rag-delete-index (==d==)= :: Delete a saved RAG index.

<<Inline-_0040rag_0028_0029-Syntax>>
*** 24.8 Inline @rag() Syntax [[#Inline-_0040rag_0028_0029-Syntax][¶]]
:PROPERTIES:
...
<<Example-Workflow>>
*** 24.9 Example Workflow [[#Example-Workflow][¶]]
:PROPERTIES:
...
** 25 Advanced Usage [[#Advanced-Usage-1][¶]]
:PROPERTIES:
...
*** 25.1 Managing Token Usage [[#Managing-Token-Usage][¶]]
:PROPERTIES:
...
*** 25.2 Customizing the Interface [[#Customizing-the-Interface][¶]]
:PROPERTIES:
...
<<Streaming-Options>>
**** 25.2.1 Streaming Options [[#Streaming-Options][¶]]
:PROPERTIES:
...
*** 25.3 Editing Conversation History [[#Editing-Conversation-History][¶]]
:PROPERTIES:
...
*** 25.4 Advanced System Prompt Management [[#Advanced-System-Prompt-Management][¶]]
:PROPERTIES:
...
**** 25.4.1 Setting a system prompt without sending [[#Setting-a-system-prompt-without-sending][¶]]
:PROPERTIES:
...
**** 25.4.2 Using a system prompt from Fabric [[#Using-a-system-prompt-from-Fabric][¶]]
:PROPERTIES:
...
*** 25.5 Using Direct API Access [[#Using-Direct-API-Access][¶]]
:PROPERTIES:
...
*** 26.1 Interactive Functions [[#Interactive-Functions][¶]]
:PROPERTIES:
...
<<Core-Functions>>
*** 26.2 Core Functions [[#Core-Functions][¶]]
:PROPERTIES:
...
*** 26.3 Customization Functions [[#Customization-Functions][¶]]
:PROPERTIES:
...
<<General-Questions>>
*** 27.1 General Questions [[#General-Questions][¶]]
:PROPERTIES:
...
**** 27.1.1 What is the difference between Ollama Buddy and other AI assistants? [[#What-is-the-difference-between-Ollama-Buddy-and-other-AI-assistants_003f][¶]]
:PROPERTIES:
...
**** 27.1.2 Does Ollama Buddy require an internet connection? [[#Does-Ollama-Buddy-require-an-internet-connection_003f][¶]]
:PROPERTIES:
...
**** 27.1.3 How do I use Ollama cloud models? [[#How-do-I-use-Ollama-cloud-models_003f][¶]]
:PROPERTIES:
...
**** 27.1.4 Which models work best with Ollama Buddy? [[#Which-models-work-best-with-Ollama-Buddy_003f][¶]]
:PROPERTIES:
...
**** 27.1.5 How much RAM do I need? [[#How-much-RAM-do-I-need_003f][¶]]
:PROPERTIES:
...
<<Usage-Questions>>
*** 27.2 Usage Questions [[#Usage-Questions][¶]]
:PROPERTIES:
...
**** 27.2.1 How do I cancel a request that's taking too long? [[#How-do-I-cancel-a-request-that_0027s-taking-too-long_003f][¶]]
:PROPERTIES:
...
**** 27.2.2 How can I save my conversations? [[#How-can-I-save-my-conversations_003f][¶]]
:PROPERTIES:
...
**** 27.2.3 Can I use multiple models in the same conversation? [[#Can-I-use-multiple-models-in-the-same-conversation_003f][¶]]
:PROPERTIES:
...
**** 27.2.4 How do I clear the conversation history? [[#How-do-I-clear-the-conversation-history_003f][¶]]
:PROPERTIES:
...
**** 27.2.5 How can I create a custom command? [[#How-can-I-create-a-custom-command_003f][¶]]
:PROPERTIES:
...
**** 27.2.6 How can I manage context windows? [[#How-can-I-manage-context-windows_003f][¶]]
:PROPERTIES:
...
**** 27.2.7 What happens when I exceed the context limit? [[#What-happens-when-I-exceed-the-context-limit_003f][¶]]
:PROPERTIES:
...
**** 27.2.8 How do I create effective system prompts? [[#How-do-I-create-effective-system-prompts_003f][¶]]
:PROPERTIES:
...
**** 27.2.9 Where are my system prompts stored? [[#Where-are-my-system-prompts-stored_003f][¶]]
:PROPERTIES:
...
<<Troubleshooting-2>>
*** 27.3 Troubleshooting [[#Troubleshooting-2][¶]]
:PROPERTIES:
...
**** 27.3.1 Ollama Buddy shows "OFFLINE" status [[#Ollama-Buddy-shows-_0022OFFLINE_0022-status][¶]]
:PROPERTIES:
...
**** 27.3.2 Responses are slow or the model seems to hang [[#Responses-are-slow-or-the-model-seems-to-hang][¶]]
:PROPERTIES:
...
**** 27.3.3 Getting "error parsing model" when pulling a model [[#Getting-_0022error-parsing-model_0022-when-pulling-a-model][¶]]
:PROPERTIES:
...
**** 27.3.4 Model responses are low quality or truncated [[#Model-responses-are-low-quality-or-truncated][¶]]
:PROPERTIES:
...
**** 27.3.5 How do system prompts differ from regular prompts? [[#How-do-system-prompts-differ-from-regular-prompts_003f][¶]]
:PROPERTIES:
...
**** 27.3.6 What is the global system prompt? [[#What-is-the-global-system-prompt_003f][¶]]
:PROPERTIES:
...
**** 27.3.7 How do I use image analysis/vision features? [[#How-do-I-use-image-analysis_002fvision-features_003f][¶]]
:PROPERTIES:
...
**** 27.3.8 Can I share system prompts between different installations? [[#Can-I-share-system-prompts-between-different-installations_003f][¶]]
:PROPERTIES:
...
** 28 Troubleshooting [[#Troubleshooting-3][¶]]
:PROPERTIES:
...
<<Common-Issues>>
*** 28.1 Common Issues [[#Common-Issues][¶]]
:PROPERTIES:
...
<<Connection-Problems>>
**** 28.1.1 Connection Problems [[#Connection-Problems][¶]]
:PROPERTIES:
...
<<Model-Problems>>
**** 28.1.2 Model Problems [[#Model-Problems][¶]]
:PROPERTIES:
...
<<Interface-Issues>>
**** 28.1.3 Interface Issues [[#Interface-Issues][¶]]
:PROPERTIES:
...
<<Enable-Debug-Mode>>
**** 28.2.1 Enable Debug Mode [[#Enable-Debug-Mode][¶]]
:PROPERTIES:
...
<<Report-Issues>>
**** 28.2.3 Report Issues [[#Report-Issues][¶]]
:PROPERTIES:
...
** 29 Contributing [[#Contributing-1][¶]]
:PROPERTIES:
...
<<Getting-Started>>
*** 29.1 Getting Started [[#Getting-Started][¶]]
:PROPERTIES:
...
<<Development-Setup>>
*** 29.2 Development Setup [[#Development-Setup][¶]]
:PROPERTIES:
...
<<Required-Tools>>
**** 29.2.1 Required Tools [[#Required-Tools][¶]]
:PROPERTIES:
...
**** 29.2.2 Recommended Packages [[#Recommended-Packages][¶]]
:PROPERTIES:
...
<<Coding-Guidelines>>
*** 29.3 Coding Guidelines [[#Coding-Guidelines][¶]]
:PROPERTIES:
...
<<Run-Existing-Tests>>
**** 29.4.1 Run Existing Tests [[#Run-Existing-Tests][¶]]
:PROPERTIES:
...
<<Adding-New-Tests>>
**** 29.4.2 Adding New Tests [[#Adding-New-Tests][¶]]
:PROPERTIES:
...
*** 29.5 Feature Requests and Bug Reports [[#Feature-Requests-and-Bug-Reports][¶]]
:PROPERTIES:
...
**** 29.5.1 User System Prompts Issues [[#User-System-Prompts-Issues][¶]]
:PROPERTIES:
