...
(defcustom ollama-buddy-codestral-marker-prefix "c:"
...
(defcustom ollama-buddy-codestral-default-model ""
  "Default Mistral Codestral model to use."
  :type 'string
  :group 'ollama-buddy-codestral)

(defcustom ollama-buddy-codestral-api-endpoint ""
                               ...
                               (with-current-buffer ollama-buddy--chat-buffer
                                 (let ((inhibit-read-only t))
                                   ...
                                   (when ollama-buddy-display-token-stats
                                     (insert (format "\n\n*** Token Stats\n[%d tokens]"
                                                     ollama-codestral--current-token-count)))
