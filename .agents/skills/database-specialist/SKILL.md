...
description: >
  Database design, optimization, and query construction across SQL
  databases. Trigger on phrases like "database help", "sql help",
  "database design", "sql query", "database optimization",
  "postgresql help".
---
