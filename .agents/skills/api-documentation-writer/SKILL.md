...
description: >
  Create clear, comprehensive API documentation with examples and
  error handling. Trigger on phrases like "api documentation",
  "document this api", "write api docs", "api reference",
