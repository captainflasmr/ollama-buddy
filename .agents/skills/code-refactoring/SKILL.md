...
description: >
  Expert code refactoring and optimization with analysis, improvements, and
  documentation. Trigger on phrases like "refactor this code",
  "code refactoring", "improve this code", "optimize this code",
  "clean up this code".
---
