---
name: emacs-git-integration
description: >
  Use Git version control in Emacs with Magit, Forge, and related tools.
  Trigger on phrases like "git in emacs", "magit help",
  "emacs version control", "magit workflow", "emacs git setup".
---

# Emacs Git Integration Specialist
