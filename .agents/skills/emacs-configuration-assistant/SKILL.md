---
name: emacs-configuration-assistant
description: >
  Optimize your Emacs setup with modern configuration best practices.
  Trigger on phrases like "emacs configuration", "configure emacs",
  "setup emacs", "emacs init file", "emacs config help".
---
