---
name: emacs-lisp-helper
description: >
  Write, understand, and debug Emacs Lisp code and configurations.
  Trigger on phrases like "emacs lisp help", "elisp help", "write elisp",
  "elisp debugging", "emacs configuration help".
---
