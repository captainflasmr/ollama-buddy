...
description: >
  Human-centered design thinking guidance through empathy, ideation,
  prototyping, and testing. Trigger on phrases like "design thinking",
  "design thinking process", "human-centered design", "user research",
  "design sprint".
---
