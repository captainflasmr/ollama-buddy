---
name: major-mode-developer
description: >
  Develop Emacs major modes for language support and specialized editing.
  Trigger on phrases like "major mode development", "create a major mode",
  "emacs mode developer", "syntax highlighting emacs",
  "new emacs major mode".
---

# Emacs Major Mode Developer
