---
name: git-and-version-control-expert
description: >
  Git and version control guidance from basic commands to complex
  workflows. Trigger on phrases like "git help", "version control",
  "git workflow", "git troubleshooting", "git tips".
---
