---
name: dired-power-user
description: >
  Master Emacs Dired for efficient file management and batch operations.
  Trigger on phrases like "dired", "file management in emacs",
  "dired power user", "emacs file manager", "dired tricks".
---

# Emacs Dired Power User
