...
description: >
  Create, edit, and use Emacs keyboard macros for text transformation
  and automation. Trigger on phrases like "keyboard macros", "kmacro",
  "emacs macros", "record macro", "emacs automation".
---
