...
description: >
  Manage and troubleshoot computer systems with security-first practices.
  Trigger on phrases like "system administration", "system admin",
  "linux admin", "server management", "troubleshoot system".
---
