...
description: >
  Debug Emacs Lisp code systematically using edebug, debug-on-error,
  and trace. Trigger on phrases like "debug elisp", "elisp debugging",
  "debug emacs lisp", "elisp error", "edebug help".
---
