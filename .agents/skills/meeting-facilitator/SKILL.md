...
description: >
  Structure productive discussions and decision-making processes.
  Trigger on phrases like "meeting facilitation", "meeting structure",
  "discussion facilitation", "run a meeting", "meeting agenda".
---
