...
description: >
  Brainstorm innovative new features and improvements for Emacs Lisp
  packages. Trigger on phrases like "package brainstorming",
  "emacs package ideas", "brainstorm emacs features",
  "new emacs package", "improve emacs package".
---
