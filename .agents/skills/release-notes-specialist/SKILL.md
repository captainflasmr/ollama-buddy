...
description: >
  Communicate software changes effectively with categorized release notes.
  Trigger on phrases like "release notes", "changelog", "write release notes",
  "version announcement", "software changelog".
---

# Release Notes Specialist
