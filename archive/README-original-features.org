...
H  Toggle History   N  New Session         S  Settings
...
s  Send with Pattern  S  Sync Latest      u  Universal Patterns
...
The welcome screen shows essential keybindings at the top, with additional commands under a folded =** More Commands= org heading that can be expanded with =TAB=.
